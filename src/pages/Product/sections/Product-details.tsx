...
export const ProductDetail = () => {
    ...
    return (
        <section data-id="product-details" className="w-full h-full mt-4 flex flex-col lg:flex-row">
            ...
            {
                tag === 'description' && (
                    <section data-id="description" className="p-4 border lg:w-3/4 xl:text-xl xl:p-8">
            ...
            }
            {
                tag === 'reviews' && (
                    <section className="border p-2 pb-8 lg:w-3/4">
                        <article className="border-b flex flex-col gap-2 p-2 xl:p-6 pb-8 mb-4">
                            <span className="font-bold xl:text-xl">Abraham</span>
                            <Rating rating={4} size="small" />
                            <p className="xl:text-2xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
