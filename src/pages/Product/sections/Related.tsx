...
export const Related = () => {
    return (
        <div id="related" className="w-full h-full">
            ...
            <div id="related-grid" className='grid grid-cols-2 gap-4'>
                <article className='flex flex-col col-span-2 md:col-span-1 gap-2 p-6 mt-4 border border-black text-lg'>
