    ...
    return (
        <article className="group bg-white border shadow-sm flex flex-col p-3 overflow-hidden hover:border-black">
                        <div className="w-full flex justify-center p-4">
                            <img src={urlImg} className="max-w-[400px] max-h-[400px]" alt="book cover" />
                        </div>
                    ...
                    md:p-0
                    ">
                <p className="uppercase text-xl text-red-600 tracking-wide">{tags.join(", ")}</p>
                <h2 className="text-3xl font-semibold">{title}</h2>
                <p className="italic font-thin text-lg">{author}</p>
                ...
                <div className="
                    ...
                    <div className="flex gap items-center">
                        ...
                        rounded-full
                        p-3
                        hover:cursor-pointer w-12 h-12  
                    ...
                    <div className="w-12 h-12 hover:bg-blue-500 animate-all duration-200 p-2 rounded-full overflow-hidden box-content">
