...
export const CartCard: React.FC<Book> = ({ urlImg, tags, author, price, rating, title }) => {
    return (
        <article className="group bg-white border shadow-sm flex  p-1 overflow-hidden hover:border-black">
                        <div className="w-2/4 flex justify-center p-2">
                    ...
                    md:p-0
                    ">
                <p className="uppercase text text-red-600 tracking-wide">{tags.join(", ")}</p>
