...
export const CartCard: React.FC<Book> = ({ urlImg, tags, author, price, rating, title }) => {
    return (
        <article className=" group bg-white border shadow-sm flex flex-col md:p-3 p-0 overflow-hidden hover:border-black">
            <div className="w-full h-[150px] md:h-full flex justify-center p-0 md:p-4 md:pb-20">
                <img src={urlImg} className="object-cover object-center w-full h-full" alt="book cover" />
            </div>
            <div className="
                    transform 
